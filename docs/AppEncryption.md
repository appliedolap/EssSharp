...
------------ | ------------- | ------------- | -------------
**Type** | **string** | &lt;p&gt;The supported encryption type. The only supported value is &lt;code&gt;OCID&lt;/code&gt;, representing Oracle Vault key management.&lt;/p&gt; | [optional] 
**Key** | **List&lt;byte[]&gt;** |  | [optional] 
