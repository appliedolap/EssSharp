...
**CostOfQueryingIncrementalData** | **double** | &lt;p&gt;For aggregate storage cubes, the average percentage of query time spent processing incremental data slices. This is useful in deciding when slices should be merged together to improve query performance.&lt;/p&gt; | [optional]
