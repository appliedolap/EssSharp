...
------------ | ------------- | ------------- | -------------
**CurrencyDatabase** | **string** | &lt;p&gt;The currency cube. By assigning currency tags to members in the main cube outline, you enable Essbase to generate the currency cube automatically. In the &lt;code&gt;Sample_Currency&lt;/code&gt; application, the currency cube is &lt;code&gt;Xchgrate&lt;/code&gt;.&lt;/p&gt; | [optional] 
