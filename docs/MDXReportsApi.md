# EssSharp.Api.MDXReportsApi

All URIs are relative to */essbase/rest/v1*

| Method | HTTP request | Description |
|--------|--------------|-------------|
| [**NamedqueriesDeleteNamedQuery**](MDXReportsApi.md#namedqueriesdeletenamedquery) | **DELETE** /applications/{application}/databases/{database}/queries/{query} | Delete MDX Report |
| [**NamedqueriesEditNamedQuery**](MDXReportsApi.md#namedquerieseditnamedquery) | **PUT** /applications/{application}/databases/{database}/queries/{query} | Update MDX Report |
...
namespace Example
{
    public class NamedqueriesDeleteNamedQueryExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new MDXReportsApi(config);
            ...
            {
                Debug.Print("Exception when calling MDXReportsApi.NamedqueriesDeleteNamedQuery: " + e.Message);
...
{
    Debug.Print("Exception when calling MDXReportsApi.NamedqueriesDeleteNamedQueryWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class NamedqueriesEditNamedQueryExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling MDXReportsApi.NamedqueriesEditNamedQuery: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling MDXReportsApi.NamedqueriesEditNamedQueryWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class NamedqueriesGetNamedQueriesExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling MDXReportsApi.NamedqueriesGetNamedQueries: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling MDXReportsApi.NamedqueriesGetNamedQueriesWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class NamedqueriesGetNamedQueryDetailsExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling MDXReportsApi.NamedqueriesGetNamedQueryDetails: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling MDXReportsApi.NamedqueriesGetNamedQueryDetailsWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class NamedqueriesSaveNamedQueryExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling MDXReportsApi.NamedqueriesSaveNamedQuery: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling MDXReportsApi.NamedqueriesSaveNamedQueryWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class RenameExample
    {
        public static void Main()
        {
            ...
            var application = "application_example";  // string | <p>Application name.</p>
            var database = "database_example";  // string | <p>Database name.</p>
            var source = "source_example";  // string | <p>Existing name of MDX report</p>
            var dest = "dest_example";  // string | <p>New name of MDX report</p>
            ...
            {
                Debug.Print("Exception when calling MDXReportsApi.Rename: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling MDXReportsApi.RenameWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
| **application** | **string** | &lt;p&gt;Application name.&lt;/p&gt; |  |
| **database** | **string** | &lt;p&gt;Database name.&lt;/p&gt; |  |
| **source** | **string** | &lt;p&gt;Existing name of MDX report&lt;/p&gt; |  |
| **dest** | **string** | &lt;p&gt;New name of MDX report&lt;/p&gt; |  |
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
| **200** | &lt;p&gt;&lt;strong&gt;OK&lt;/strong&gt;&lt;/p&gt;&lt;p&gt;MDX report renamed successfully.&lt;/p&gt; |  -  |
| **400** | &lt;p&gt;&lt;strong&gt;Bad Request&lt;/strong&gt;&lt;/p&gt;&lt;p&gt;Failed to rename MDX query.&lt;/p&gt; |  -  |
