...
<a id="filesaddfile"></a>
# **FilesAddFile**
> GenericEntity FilesAddFile (string path, System.IO.Stream stream, bool overwrite, bool append = null)
...
namespace Example
{
    public class FilesAddFileExample
    {
        public static void Main()
        {
            ...
            {
                // Upload File or Create Folder
                GenericEntity result = apiInstance.FilesAddFile(path, stream, overwrite, append);
...
{
    // Upload File or Create Folder
    ApiResponse<GenericEntity> response = apiInstance.FilesAddFileWithHttpInfo(path, stream, overwrite, append);
