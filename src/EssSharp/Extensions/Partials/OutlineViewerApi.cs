...
namespace EssSharp.Api
{
    ...
    public partial class OutlineViewerApi
    {
        ...
        {
            EssSharp.Client.ApiResponse<List<MemberBean>> localVarResponse =
                await OutlineGetDynamicTimeSeriesMemberInfoWithHttpInfoAsync(app, cube, fields, operationIndex,
        ...
        public async System.Threading.Tasks.Task<EssSharp.Client.ApiResponse<List<MemberBean>>> OutlineGetDynamicTimeSeriesMemberInfoWithHttpInfoAsync(string app, string cube, string fields = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            if (app == null)
            {
                throw new EssSharp.Client.ApiException(400,
                    "Missing required parameter 'app' when calling OutlineViewerApi->OutlineGetMemberInfo");
            }
            ...
            {
                throw new EssSharp.Client.ApiException(400,
                    "Missing required parameter 'cube' when calling OutlineViewerApi->OutlineGetMemberInfo");
            }
            ...
            localVarRequestOptions.PathParameters.Add("app",
                EssSharp.Client.ClientUtils.ParameterToString(app)); // path parameter
            localVarRequestOptions.PathParameters.Add("cube",
                EssSharp.Client.ClientUtils.ParameterToString(cube)); // path parameter
            ...
            localVarRequestOptions.QueryParameters.Add(
                EssSharp.Client.ClientUtils.ParameterToMultiMap("", "queryType", "DTSMEMBERS")); // Query parameter
            localVarRequestOptions.QueryParameters.Add(
                EssSharp.Client.ClientUtils.ParameterToMultiMap("", "queryOptions",
                    "MEMBERSANDALIASES")); // Query parameter
            if (fields != null)
            {
                localVarRequestOptions.QueryParameters.Add(
                    EssSharp.Client.ClientUtils.ParameterToMultiMap("", "fields", fields));
            }
                ...
                !localVarRequestOptions.HeaderParameters.ContainsKey("Authorization"))
            {
                localVarRequestOptions.HeaderParameters.Add("Authorization",
                    "Basic " + EssSharp.Client.ClientUtils.Base64Encode(this.Configuration.Username + ":" +
                                                                        this.Configuration.Password));
            }

            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient
                .GetAsync<List<MemberBean>>("/outline/{app}/{cube}/{memberUniqueName}", localVarRequestOptions,
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of MemberBean</returns>
        public async System.Threading.Tasks.Task<List<MemberBean>> OutlineGetMembersSelectedAsync( string app, string cube, string queryType, string queryOptions, string search = null, string dimensionName = null, string aliasName = null, string fields = default(string), int limit = 500, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken) )
        {
            EssSharp.Client.ApiResponse<List<MemberBean>> localVarResponse = await OutlineGetMembersSelectedWithHttpInfoAsync(app, cube, queryType, queryOptions,search, dimensionName, aliasName, fields, limit, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (MemberBean)</returns>
        public async System.Threading.Tasks.Task<EssSharp.Client.ApiResponse<List<MemberBean>>> OutlineGetMembersSelectedWithHttpInfoAsync( string app, string cube, string queryType, string queryOptions, string search = null, string dimensionName = null, string aliasName = null, string fields = default(string), int limit = 500, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken) )
        {
            // verify the required parameter 'app' is set
            if ( app == null )
            {
            ...
            localVarRequestOptions.PathParameters.Add("memberUniqueName", "memberSelection"); // path parameter
            localVarRequestOptions.QueryParameters.Add(EssSharp.Client.ClientUtils.ParameterToMultiMap("", "queryType", queryType)); // Query parameter
            localVarRequestOptions.QueryParameters.Add(EssSharp.Client.ClientUtils.ParameterToMultiMap("", "limit", limit)); // Query parameter
            localVarRequestOptions.QueryParameters.Add(EssSharp.Client.ClientUtils.ParameterToMultiMap("", "queryOptions", queryOptions)); // Query parameter
            if (search is not null)
            {
                localVarRequestOptions.QueryParameters.Add(EssSharp.Client.ClientUtils.ParameterToMultiMap("", "search", search)); // Query parameter
            }
            if ( dimensionName is not null )
            {
                localVarRequestOptions.QueryParameters.Add(EssSharp.Client.ClientUtils.ParameterToMultiMap("", "dimName", dimensionName)); // Query parameter
            }
            if ( aliasName is not null )
            {
                localVarRequestOptions.QueryParameters.Add(EssSharp.Client.ClientUtils.ParameterToMultiMap("", "aliasName", aliasName)); // Query parameter
            }
            if ( fields != null )
            {
