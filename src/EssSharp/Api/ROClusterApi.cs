...
namespace EssSharp.Api
{
    ...
    public interface IROClusterApiSync : IApiAccessor
    {
        ...
        Dictionary<string, Object> ROClusterGetAppAndCubeListByServerName(string svrName, int operationIndex = 0);
        ...
        ApiResponse<Dictionary<string, Object>> ROClusterGetAppAndCubeListByServerNameWithHttpInfo(string svrName, int operationIndex = 0);
        /// <summary>
    ...
    public partial class ROClusterApi : IROClusterApi
    {
        ...
        /// <summary>
        /// ReadOnly Cluster Change Status  &lt;p&gt;Change Status allows to modify the state 1 (enable)/ 2(disable) of ReadOnly cluster nodes&lt;/p&gt;
        /// </summary>
        /// <exception cref="EssSharp.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="body">RoCluster</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>Dictionary&lt;string, Object&gt;</returns>
        public Dictionary<string, Object> ROClusterGetAppAndCubeListByServerName(string svrName, int operationIndex = 0)
        {
            EssSharp.Client.ApiResponse<Dictionary<string, Object>> localVarResponse = ROClusterGetAppAndCubeListByServerNameWithHttpInfo(svrName);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Dictionary&lt;string, Object&gt;</returns>
        public EssSharp.Client.ApiResponse<Dictionary<string, Object>> ROClusterGetAppAndCubeListByServerNameWithHttpInfo(string svrName, int operationIndex = 0)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<Dictionary<string, Object>>("/rocluster/{svrName}/appcubelist", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<EssSharp.Client.ApiResponse<Dictionary<string, Object>>> ROClusterGetAppAndCubeListByServerNameWithHttpInfoAsync(string svrName, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<Dictionary<string, Object>>("/rocluster/{svrName}/appcubelist", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Get ReadOnly Cluster List Returns list of ReadOnly cluster from Essbase domain db.
        /// </summary>
        /// <exception cref="EssSharp.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>List&lt;ROCluster&gt;</returns>
