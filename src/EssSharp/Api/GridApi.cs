...
namespace EssSharp.Api
{
    ...
    public interface IGridApiSync : IApiAccessor
    {
        ...
        /// <param name="svParity">&lt;p&gt;Default is true. When &lt;code&gt;repeatMemberLabels&lt;/code&gt; is set to false in the Essbase session&#39;s grid preferences, repeated headings for column/page orientation on the grid are not preserved after a retrieval in the REST API, whereas they are preserved in the similar Java API operation. If you require preservation of repeated column headings (Java API like behavior), set &lt;code&gt;svParity&lt;/code&gt; to false.&lt;/p&gt; (optional, default to true)</param>
