...
namespace EssSharp.Api
{
    ...
    public partial class GlobalDatasourcesApi : IGlobalDatasourcesApi
    {
        ...
        /// <summary>
        /// Update Global Datasource &lt;p&gt;Updates the named global-level Datasource. If the update is successful, returns details about the updated Datasource. &lt;code&gt;type&lt;/code&gt; and &lt;code&gt;connection&lt;/code&gt; are required inputs for all types of Datasources. Other required inputs differ based on the type of the Datasource.&lt;/p&gt;
        /// </summary>
        /// <exception cref="EssSharp.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="datasourceName">&lt;p&gt;Datasource name.&lt;/p&gt;</param>
        /// <param name="body">&lt;p&gt;Updated Datasource details.&lt;/p&gt; (optional)</param>
