...
namespace EssSharp.Model
{
    ...
    public partial class Script : IValidatableObject
    {
        ...
        public Script(string content = default, List<Link> links = default, long modifiedTime = default, bool locked = default, long lockedTime = default, string lockedBy = default, long sizeInBytes = default, string name = default)
        {
