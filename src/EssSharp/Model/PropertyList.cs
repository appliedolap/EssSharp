...
namespace EssSharp.Model
{
    ...
    public partial class PropertyList : IValidatableObject
    {
        ...
        public PropertyList(List<PropertyEntry> items = default, long count = default, long totalResults = default, bool hasMore = default, long limit = default, Dictionary<string, string> properties = default, long offset = default)
        {
            this.Items = items;
            this.Count = count;
