...
namespace EssSharp.Model
{
    ...
    public partial class PropertyList : IEquatable<PropertyList>, IValidatableObject
    {
        ...
        public PropertyList(List<PropertyEntry> items = default(List<PropertyEntry>), bool hasMore = default(bool), long totalResults = default(long), long count = default(long), long limit = default(long), Dictionary<string, string> properties = default(Dictionary<string, string>), long offset = default(long))
        {
            this.Items = items;
