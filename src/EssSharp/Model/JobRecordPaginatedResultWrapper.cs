...
namespace EssSharp.Model
{
    ...
    /// </summary>
    [DataContract(Name = "JobRecordPaginatedResultWrapper")]
    public partial class JobRecordPaginatedResultWrapper : IEquatable<JobRecordPaginatedResultWrapper>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="JobRecordPaginatedResultWrapper" /> class.
        /// </summary>
        ...
        public List<JobRecordBean> Items { get; set; }
        ...
        {
            return this.Equals(input as JobRecordPaginatedResultWrapper);
        }

        /// <summary>
        /// Returns true if JobRecordPaginatedResultWrapper instances are equal
        /// </summary>
        /// <param name="input">Instance of JobRecordPaginatedResultWrapper to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(JobRecordPaginatedResultWrapper input)
        {
            if (input == null)
            {
                return false;
