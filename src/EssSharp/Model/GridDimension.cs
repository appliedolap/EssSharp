...
namespace EssSharp.Model
{
    ...
    public partial class GridDimension : IValidatableObject
    {
        ...
        public GridDimension(int column = default, int row = default, string pov = default, bool expanded = default, string displayName = default, string name = default, bool hidden = default)
        {
            this.Column = column;
            this.Row = row;
            this.Pov = pov;
