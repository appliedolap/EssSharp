...
namespace EssSharp.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DatabaseProvisionReportItemList")]
    public partial class DatabaseProvisionReportItemList : IEquatable<DatabaseProvisionReportItemList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DatabaseProvisionReportItemList" /> class.
        /// </summary>
        ...
        public List<DatabaseProvisionReportItem> Items { get; set; }
        ...
        {
            return this.Equals(input as DatabaseProvisionReportItemList);
        }

        /// <summary>
        /// Returns true if DatabaseProvisionReportItemList instances are equal
        /// </summary>
        /// <param name="input">Instance of DatabaseProvisionReportItemList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DatabaseProvisionReportItemList input)
        {
            if (input == null)
            {
                return false;
