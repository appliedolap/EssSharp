...
namespace EssSharp.Model
{
    ...
    public partial class CubeList : IEquatable<CubeList>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as CubeList);
        }

        /// <summary>
        /// Returns true if CubeList instances are equal
        /// </summary>
        /// <param name="input">Instance of CubeList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CubeList input)
        {
            if (input == null)
            {
                return false;
