...
namespace EssSharp.Model
{
    ...
    public partial class CubeList : IValidatableObject
    {
        ...
        public CubeList(List<Cube> items = default, long count = default, long totalResults = default, bool hasMore = default, long limit = default, Dictionary<string, string> properties = default, long offset = default)
        {
            this.Items = items;
            this.Count = count;
