...
namespace EssSharp.Model
{
    ...
    public partial class PartitionList : IValidatableObject
    {
        /// <summary>
        ...
        public PartitionList(List<PartitionBean> items = default, long offset = default, long limit = default, long totalResults = default, long count = default, bool hasMore = default, Dictionary<string, string> properties = default)
        {
            this.Items = items;
            this.Offset = offset;
            this.Limit = limit;
