...
namespace EssSharp.Model
{
    ...
    public partial class CacheSettings : IValidatableObject
    {
        ...
        /// <param name="dataFileCacheCurrentValue">&lt;p&gt;The run-time data file cache size (in KB) currently in use by the cube. Once you have changed the data file cache size, you must stop and restart the cube for the new data file cache size to take effect.&lt;/p&gt;.</param>
        ...
        /// <summary>
        /// &lt;p&gt;The run-time data file cache size (in KB) currently in use by the cube. Once you have changed the data file cache size, you must stop and restart the cube for the new data file cache size to take effect.&lt;/p&gt;
        /// </summary>
        /// <value>&lt;p&gt;The run-time data file cache size (in KB) currently in use by the cube. Once you have changed the data file cache size, you must stop and restart the cube for the new data file cache size to take effect.&lt;/p&gt;</value>
