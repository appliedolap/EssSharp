...
namespace EssSharp.Model
{
    ...
    public partial class Queries : IValidatableObject
    {
        ...
        public Queries(long count = default, List<QueryMetadata> items = default, long totalResults = default, bool hasMore = default, long limit = default, Dictionary<string, string> properties = default, long offset = default)
        {
            this.Count = count;
            this.Items = items;
