...
namespace EssSharp.Model
{
    ...
    public partial class RunTimeParametersInfo : IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        public RunTimeParametersInfo(string dimension = default, string generation = default, string level = default, TypeEnum? type = default, int generationNumber = default)
        {
