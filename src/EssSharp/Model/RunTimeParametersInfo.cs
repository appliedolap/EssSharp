...
namespace EssSharp.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RunTimeParametersInfo")]
    public partial class RunTimeParametersInfo : IEquatable<RunTimeParametersInfo>, IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RunTimeParametersInfo" /> class.
        /// </summary>
        ...
        public RunTimeParametersInfo(string dimension = default(string), string generation = default(string), string level = default(string), TypeEnum? type = default(TypeEnum?), int generationNumber = default(int))
        {
        ...
        {
            return this.Equals(input as RunTimeParametersInfo);
        }

        /// <summary>
        /// Returns true if RunTimeParametersInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of RunTimeParametersInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RunTimeParametersInfo input)
        {
            if (input == null)
            {
                return false;
