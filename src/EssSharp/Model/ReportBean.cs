...
namespace EssSharp.Model
{
    ...
    public partial class ReportBean : IValidatableObject
    {
        ...
        public ReportBean(List<Link> links = default, long lockedTime = default, bool locked = default, long modifiedTime = default, long sizeInBytes = default, string lockedBy = default, string name = default)
        {
            this.Links = links;
