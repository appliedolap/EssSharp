...
namespace EssSharp.Model
{
    ...
    public partial class ReportBean : IValidatableObject
    {
        ...
        public ReportBean(List<Link> links = default, long modifiedTime = default, bool locked = default, long lockedTime = default, string lockedBy = default, long sizeInBytes = default, string name = default)
        {
            this.Links = links;
