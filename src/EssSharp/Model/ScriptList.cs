...
namespace EssSharp.Model
{
    ...
    public partial class ScriptList : IValidatableObject
    {
        ...
        public ScriptList(List<Script> items = default, long count = default, long totalResults = default, bool hasMore = default, long limit = default, Dictionary<string, string> properties = default, long offset = default)
        {
            this.Items = items;
            this.Count = count;
