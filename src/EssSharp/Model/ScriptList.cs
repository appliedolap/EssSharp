...
namespace EssSharp.Model
{
    ...
    public partial class ScriptList : IValidatableObject
    {
        ...
        public ScriptList(List<Script> items = default, bool hasMore = default, long totalResults = default, long count = default, long limit = default, Dictionary<string, string> properties = default, long offset = default)
        {
            this.Items = items;
