...
namespace EssSharp.Model
{
    ...
    public partial class StorageStatistics : IValidatableObject
    {
        ...
        /// <param name="costOfQueryingIncrementalData">&lt;p&gt;For aggregate storage cubes, the average percentage of query time spent processing incremental data slices. This is useful in deciding when slices should be merged to improve query performance.&lt;/p&gt;.</param>
        ...
        /// <summary>
        /// &lt;p&gt;For aggregate storage cubes, the average percentage of query time spent processing incremental data slices. This is useful in deciding when slices should be merged to improve query performance.&lt;/p&gt;
        /// </summary>
        /// <value>&lt;p&gt;For aggregate storage cubes, the average percentage of query time spent processing incremental data slices. This is useful in deciding when slices should be merged to improve query performance.&lt;/p&gt;</value>
