...
namespace EssSharp.Model
{
    ...
    public partial class ApplicationProvisionReportItemList : IValidatableObject
    {
        ...
        public ApplicationProvisionReportItemList(List<ApplicationProvisionReportItem> items = default, List<Link> links = default, long totalResults = default, bool hasMore = default, long count = default, long limit = default, Dictionary<string, string> properties = default, long offset = default)
        {
            this.Items = items;
            this.Links = links;
