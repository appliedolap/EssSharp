...
namespace EssSharp.Model
{
    ...
    public partial class ProvisionReportItemList : IEquatable<ProvisionReportItemList>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ProvisionReportItemList);
        }

        /// <summary>
        /// Returns true if ProvisionReportItemList instances are equal
        /// </summary>
        /// <param name="input">Instance of ProvisionReportItemList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProvisionReportItemList input)
        {
            if (input == null)
            {
                return false;
