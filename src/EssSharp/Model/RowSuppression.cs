...
namespace EssSharp.Model
{
    ...
    public partial class RowSuppression : IEquatable<RowSuppression>, IValidatableObject
    {
        /// <summary>
        ...
        public RowSuppression(bool zero = default(bool), bool missing = default(bool), bool underScore = default(bool), bool derived = default(bool), bool noAccess = default(bool), bool emptyBlocks = default(bool), bool invalid = default(bool), bool error = default(bool))
        {
            this.Zero = zero;
        ...
        {
            return this.Equals(input as RowSuppression);
        }

        /// <summary>
        /// Returns true if RowSuppression instances are equal
        /// </summary>
        /// <param name="input">Instance of RowSuppression to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RowSuppression input)
        {
            if (input == null)
            {
                return false;
