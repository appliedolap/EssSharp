...
namespace EssSharp.Model
{
    ...
    /// HeaderType
    /// </summary>
    [DataContract(Name = "HeaderType")]
    public partial class HeaderType : IEquatable<HeaderType>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as HeaderType);
        }

        /// <summary>
        /// Returns true if HeaderType instances are equal
        /// </summary>
        /// <param name="input">Instance of HeaderType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HeaderType input)
        {
            if (input == null)
            {
                return false;
