...
namespace EssSharp.Model
{
    ...
    public partial class CollectionResponse : IValidatableObject
    {
        ...
        public CollectionResponse(long count = default, List<Object> items = default, long totalResults = default, bool hasMore = default, long limit = default, Dictionary<string, string> properties = default, long offset = default)
        {
            this.Count = count;
            this.Items = items;
