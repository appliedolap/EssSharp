...
namespace EssSharp.Model
{
    ...
    public partial class CollectionResponse : IEquatable<CollectionResponse>, IValidatableObject
    {
        ...
        public CollectionResponse(long totalResults = default(long), bool hasMore = default(bool), long count = default(long), List<Object> items = default(List<Object>), long limit = default(long), Dictionary<string, string> properties = default(Dictionary<string, string>), long offset = default(long))
        {
