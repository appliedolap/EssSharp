...
namespace EssSharp.Model
{
    ...
    public partial class Dimension : IValidatableObject
    {
        ...
        /// <param name="solveOrder">&lt;p&gt;Priority in which the dimension or member is calculated (0 to 127). Higher solve order means the member is calculated later. Members not assigned a solve order inherit it from their dimension.&lt;/p&gt;.</param>
        ...
        /// <summary>
        /// &lt;p&gt;Priority in which the dimension or member is calculated (0 to 127). Higher solve order means the member is calculated later. Members not assigned a solve order inherit it from their dimension.&lt;/p&gt;
        /// </summary>
        /// <value>&lt;p&gt;Priority in which the dimension or member is calculated (0 to 127). Higher solve order means the member is calculated later. Members not assigned a solve order inherit it from their dimension.&lt;/p&gt;</value>
