...
namespace EssSharp.Model
{
    ...
    public partial class Roles : IValidatableObject
    {
        ...
        public Roles(List<RoleBean> items = default, long count = default, long totalResults = default, bool hasMore = default, long limit = default, Dictionary<string, string> properties = default, long offset = default)
        {
            this.Items = items;
            this.Count = count;
