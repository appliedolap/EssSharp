...
namespace EssSharp.Model
{
    ...
    public partial class Roles : IEquatable<Roles>, IValidatableObject
    {
        ...
        public Roles(List<RoleBean> items = default(List<RoleBean>), bool hasMore = default(bool), long totalResults = default(long), long count = default(long), long limit = default(long), Dictionary<string, string> properties = default(Dictionary<string, string>), long offset = default(long))
        {
            this.Items = items;
