...
namespace EssSharp.Model
{
    ...
    public partial class LockObject : IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        public LockObject(List<Link> links = default, string user = default, string name = default, TypeEnum? type = default, long time = default)
        {
            this.Links = links;
            this.User = user;
            this.Name = name;
