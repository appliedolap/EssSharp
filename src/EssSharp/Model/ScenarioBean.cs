...
namespace EssSharp.Model
{
    ...
    public partial class ScenarioBean : IValidatableObject
    {
        ...
        public ScenarioBean(List<Link> links = default, bool scenarioUser = default, bool overdue = default, long createdTime = default, long submittedTime = default, long appliedTime = default, long refreshedTime = default, bool useCalculatedValues = default, int commentsCount = default, string description = default, string application = default, string database = default, List<ParticipantBean> participants = default, string owner = default, List<ApproverBean> approvers = default, string sandbox = default, List<ScriptBean> scripts = default, long dueDate = default, StateEnum? state = default, long id = default, string name = default, PriorityEnum? priority = default)
        {
            this.Links = links;
