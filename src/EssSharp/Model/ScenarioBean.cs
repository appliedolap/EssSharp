...
namespace EssSharp.Model
{
    ...
    public partial class ScenarioBean : IValidatableObject
    {
        /// <summary>
        /// Defines Priority
        /// </summary>
        ...
        public ScenarioBean(List<Link> links = default, bool scenarioUser = default, string database = default, List<ParticipantBean> participants = default, string application = default, string description = default, bool useCalculatedValues = default, bool overdue = default, long createdTime = default, long submittedTime = default, long appliedTime = default, long refreshedTime = default, int commentsCount = default, List<ScriptBean> scripts = default, string sandbox = default, long dueDate = default, List<ApproverBean> approvers = default, string name = default, PriorityEnum? priority = default, long id = default, StateEnum? state = default, string owner = default)
        {
            this.Links = links;
